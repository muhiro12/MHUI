...
struct MHStyleResolutionTests {
    ...
    func action_button_resolution_stays_quiet_and_semantic() {
        ...
        #expect(destructive.backgroundStyle?.borderRole == .destructiveBorder)
    ...
    func surface_and_group_styles_resolve_from_theme_tokens() {
        ...
        #expect(grouped.dividerColorRole == theme.divider.colorRole)
        ...
        #expect(enabledSurface.glassTintRole == .surfaceTint)
    ...
    func input_and_badge_styles_resolve_from_theme_tokens() {
        ...
        #expect(focusedInput.backgroundStyle.accentBorderOpacity == 0.24)
        ...
        #expect(invalidInput.backgroundStyle.fallbackFillRole == .inputInvalidFill)
        #expect(!invalidInput.backgroundStyle.usesGlass)
        #expect(invalidInput.backgroundStyle.borderRole == .destructiveBorder)
        ...
        #expect(neutralBadge.backgroundStyle.fallbackFillRole == .badgeNeutralFill)
        #expect(neutralBadge.backgroundStyle.borderRole == .badgeNeutralBorder)
        #expect(accentBadge.foregroundRole == .accent)
        #expect(accentBadge.backgroundStyle.accentBorderOpacity == 0.14)
