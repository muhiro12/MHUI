...
struct MHStyleResolutionTests {
    ...
    func compact_layout_resolution_uses_theme_owned_fallbacks() {
        ...
        #expect(grouped.dividerLeadingInset == .zero)
    ...
    func surface_and_group_styles_resolve_from_theme_tokens() {
        ...
        #expect(grouped.rowChrome.horizontalInset == .zero)
        #expect(grouped.rowChrome.verticalPadding == theme.resolvedRowChromeStyle().verticalPadding)
        #expect(grouped.rowChrome.minimumHeight == theme.resolvedRowChromeStyle().minimumHeight)
