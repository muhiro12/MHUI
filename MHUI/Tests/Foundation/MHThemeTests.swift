...
struct MHThemeTests {
    ...
    func standard_theme_uses_semantic_defaults() {
        ...
        #expect(theme.colors.background == .system(.background))
        #expect(theme.colors.surface == .system(.surface))
        #expect(theme.colors.surfaceElevated == .system(.surfaceElevated))
        #expect(theme.colors.surfaceMuted == .system(.surfaceMuted))
        #expect(theme.colors.border == .system(.border))
        #expect(theme.colors.primaryText == .system(.primaryText))
        #expect(theme.colors.secondaryText == .system(.secondaryText))
        #expect(theme.colors.tertiaryText == .system(.tertiaryText))
        ...
        #expect(theme.divider.opacity == 0.72)
        ...
        #expect(theme.layout.screen.compactContentInsetHorizontal == 10)
        ...
        #expect(theme.layout.surface.compactInsetHorizontal == 10)
        #expect(theme.layout.surface.compactInsetVertical == 10)
        #else
