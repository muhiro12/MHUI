...
struct MHThemeTests {
    ...
    func standard_theme_uses_semantic_defaults() {
        ...
        #expect(theme.spacing.screen == 56)
        #expect(theme.cornerRadius.control == 8)
        #expect(theme.cornerRadius.surface == 6)
        #expect(theme.divider.opacity == 0.45)
        ...
        #else
        #expect(theme.layout.readableContentWidth == 720)
        #expect(theme.layout.compactWidthThreshold == 640)
        #expect(theme.layout.screen.contentInsetHorizontal == 56)
        #expect(theme.layout.screen.contentInsetVertical == 64)
        #expect(theme.layout.screen.contentSpacing == 56)
        #expect(theme.layout.screen.compactContentInsetHorizontal == 24)
        #expect(theme.layout.screen.compactContentInsetVertical == 40)
        #expect(theme.layout.screen.compactContentSpacing == 36)
        #expect(theme.layout.surface.insetHorizontal == 28)
        #expect(theme.layout.surface.insetVertical == 24)
        #expect(theme.layout.surface.compactInsetHorizontal == 20)
        #expect(theme.layout.surface.compactInsetVertical == 18)
        #endif
        #if os(macOS)
        ...
        #endif
        #expect(theme.presentation.rowHorizontalInset == 28)
        #expect(theme.presentation.rowVerticalPadding == 18)
        #expect(theme.presentation.rowAccessorySpacing == 16)
        #expect(theme.presentation.compactRowHorizontalInset == 20)
        #expect(theme.presentation.compactRowVerticalPadding == 14)
        ...
        #expect(theme.surfaces.standard.borderOpacity == 0.5)
        #expect(theme.surfaces.elevated.borderOpacity == 0.65)
        #expect(theme.surfaces.muted.glassTintColorRole == nil)
        #expect(theme.surfaces.muted.borderOpacity == 0.28)
