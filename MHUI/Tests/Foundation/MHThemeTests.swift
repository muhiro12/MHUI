...
struct MHThemeTests {
    ...
    func standard_theme_uses_semantic_defaults() {
        ...
        #expect(theme.colors.accent.resolve(for: .light) == Color.accentColor)
        ...
        #expect(theme.spacing.inline < theme.spacing.control)
        #expect(theme.spacing.control < theme.spacing.content)
        #expect(theme.spacing.content < theme.spacing.section)
        #expect(theme.spacing.section < theme.spacing.screen)
        #expect(theme.cornerRadius.control == 8)
        #expect(theme.cornerRadius.surface == 8)
        #expect(theme.divider.opacity == 0.32)
        #expect(theme.motion.quick == 0.18)
        #expect(theme.motion.regular == 0.30)
        #if os(watchOS)
        #expect(theme.layout.readableContentWidth == 320)
        #expect(theme.layout.compactWidthThreshold == 304)
        #expect(theme.layout.screen.contentInsetHorizontal == 16)
        #expect(theme.layout.screen.contentInsetVertical == 16)
        #expect(theme.layout.screen.contentSpacing == 16)
        #expect(theme.layout.screen.compactContentInsetHorizontal == 16)
        #expect(theme.layout.screen.compactContentInsetVertical == 16)
        #expect(theme.layout.screen.compactContentSpacing == 16)
        #expect(theme.layout.surface.insetHorizontal == 16)
        #expect(theme.layout.surface.insetVertical == 16)
        ...
        #expect(theme.layout.compactWidthThreshold == 640)
        #expect(theme.layout.screen.contentInsetHorizontal == 40)
        #expect(theme.layout.screen.contentInsetVertical == 40)
        ...
        #endif
        #if os(macOS)
        #expect(theme.layout.control.minimumTouchTarget == 32)
        #else
        #expect(theme.layout.control.minimumTouchTarget == 48)
        #endif
        #expect(theme.presentation.rowHorizontalInset == theme.spacing.section)
        #expect(theme.presentation.rowVerticalPadding == theme.spacing.control)
        #expect(theme.presentation.rowAccessorySpacing == theme.spacing.control)
        #expect(theme.presentation.compactRowHorizontalInset == theme.spacing.control)
        #expect(theme.presentation.compactRowVerticalPadding == theme.spacing.control)
        #expect(theme.presentation.compactRowAccessorySpacing == theme.spacing.inline)
        #expect(theme.presentation.compactActionHorizontalPadding == theme.spacing.control)
        #expect(theme.presentation.compactActionVerticalPadding == theme.spacing.inline)
        #expect(theme.presentation.regularKeyValueMinimumValueWidth == theme.layout.column.minimumValueWidth)
        #expect(theme.presentation.compactKeyValueMinimumValueWidth == theme.layout.column.compactMinimumValueWidth)
        #expect(theme.presentation.compactKeyValueSpacing == theme.spacing.inline)
        #expect(theme.presentation.compactActionGroupSpacing == theme.spacing.inline)
        #expect(theme.surfaces.canvas.colorRole == .background)
        #expect(theme.surfaces.standard.colorRole == .surface)
    ...
    func standard_theme_accepts_asset_accent_sources() {
        ...
        #expect(theme.colors.accent.resolve(for: .light) == Color(MHColorAsset.warning))
        #expect(theme.colors.accent.resolve(for: .dark) == Color(MHColorAsset.warning))
    }
